    ...
    <div class="navbar navbar-default navbar-fixed-top">
      <div class="container">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="#home"><b>FitQuest</b></a>
        </div>
        <div class="navbar-collapse collapse">
          <ul class="nav navbar-nav navbar-right">
            ...
            <li><a href="#">Quem Somos</a></li>
						...
						<li><a style="font-weight: bold" href="#">Cadastre-se</a></li>
          </ul>
        </div><!--/.nav-collapse -->
      </div>
    </div>
...
<!-- COMUNIDADE FITQUEST: DADOS DE MEMBROS CADASTRADOS -->
	<div class="container">
		<div class="row mt centered">
			<div class="col-lg-6 col-lg-offset-3">
				<h1>MEMBROS DO<br/>FITQUEST</h1>
				<h3>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever.</h3>
			</div>
		</div><!-- /row -->
		...
		<div class="row centered">
			<div class="col-lg-6 col-lg-offset-3">
				<form class="form-inline" role="form">
				  ...
				  <button type="submit" class="btn btn-warning btn-lg">Me convide!</button>
				</form>					
			</div>
			<div class="col-lg-3"></div>
		</div><!-- /row -->
