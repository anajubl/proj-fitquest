...
<!-- CADASTRE-SE -->
	<div class="container" id="cadastro">
		...
		<div class="col-lg-6">
				<form class="form-inline" role="form" action="" method="post">
				  <div class="form-group">
				    Nome &nbsp<input type="text" class="form-control" id="nome" placeholder="Digite seu nome" required>
				    <br>
				    <br>
				    Email &nbsp<input type="email" class="form-control" id="email" placeholder="Digite seu e-mail" required>
				    <br>
				    <br>
				    Senha &nbsp<input type="password" class="form-control" id="senha" placeholder="Digite sua senha" required>
				    <br>
				    <br>					
					  <!--<span class="glyphicon glyphicon-ok" aria-hidden="true">	  </span>-->
					<!--</form>	-->
				...
				<div class="col-lg-6">
						Sexo<fieldset style="" id="genero" required>
					  		<input type="radio" name="genero" value="m" id="m" checked> Masculino<br>
  							<input type="radio" name="genero" value="f" id="f"> Feminino<br>
							</fieldset>
				    <br>
				    Objetivo<fieldset class="centered" id="foco" required>
				        <input type="radio" name="obj" value="fo" id="forca">Força
				        <input type="radio" name="obj" value="em" id="emagrecimento">Emagrecimento
				        <input type="radio" name="obj" value="co" id="condicionamento">Condicionamento
				    </fieldset>
				    <br>
			    </form>
			</div><!--/col-lg-6 -->
	...
	<div class="row centered">
		<div class="col-lg-6 col-lg-offset-3">
			<button type="submit" class="btn btn-warning btn-lg" id="">Cadastrar!</button>  
		</div>
	</div>
